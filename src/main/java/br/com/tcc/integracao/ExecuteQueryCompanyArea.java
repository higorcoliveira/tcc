...
public class ExecuteQueryCompanyArea {
	...
	public String toSQL(CamelContext context) throws Exception {
		...
		String anetDatabaseName = context.resolvePropertyPlaceholders(RouteConstants.ANET_DATABASE_NAME);
		...
		return QueryBuilderUtil.build(RouteConstants.QUERY_AREA_DISCRIMINATOR, validQueryXML, query);
	}
}